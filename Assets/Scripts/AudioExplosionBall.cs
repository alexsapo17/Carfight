...
public class AudioExplosionBall : MonoBehaviour
{
    ...
    private void Update()
    {
        // Trova il gameobject più vicino con il tag "ExplosionBall"
        GameObject nearestObject = FindNearestGameObjectWithTag("ExplosionBall");
        ...
        {
            // Se non viene trovato nessun gameobject con il tag "ExplosionBall", imposta il volume a zero
