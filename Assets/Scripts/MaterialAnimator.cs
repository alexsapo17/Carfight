...
public void SetAnimationForwardWithWhiteColor()
{
    SetAnimationAndColor(AnimationMode.OnceForward, Color.white);
}
public void SetAnimationForwardWithYellowColor()
{
    SetAnimationAndColor(AnimationMode.OnceForward, Color.yellow);
}
public void SetAnimationPingPongWithWhiteColor()
{
    SetAnimationAndColor(AnimationMode.PingPong, Color.white);
}
public void SetAnimationPingPongWithYellowColor()
{
    SetAnimationAndColor(AnimationMode.PingPong, Color.yellow);
}

private void SetAnimationAndColor(AnimationMode animMode, Color color)
{
    animationMode = animMode;
    radiusAnimationColor = color;
    StartAnimation();
}

public void StartAnimation()
{
    // Verifica se l'animazione è già attiva e avviala se necessario
    if (!isAnimating)
    {
        ToggleAnimation();
    }
     ...
     private void AnimateRadius()
    {
        ...
        imageComponent.material.SetColor("_Color", radiusAnimationColor); // Assicurati che "_Color" sia il nome corretto usato nel tuo shader
        ...
        imageComponent.material.SetFloat("_Radius", radius);
    }
  ...
  public void StartColorTransition()
    ...
    { 
        ...
        imageComponent.material.SetColor("_BaseColor", baseColor);
    }
